# Make it persisted volumes

# Install jsonnet-bundler – jsonnet package manager.
...
# Install go-jsonnet dependency
go install github.com/google/go-jsonnet/cmd/jsonnet@latest

# Install gojsontoyaml dependency
go install github.com/brancz/gojsontoyaml@latest

# Create PVC jsonnet file
tee prometheus-pvc.jsonnet <<EOF
local kp =
